...
- `/card?id=<cardId>` — one card's statements, purchases, and paid state, with paging
...
and nothing else. Use the Export JSON button on `/cards` as your backup —
importing merges a backup's cards, purchases, and payments back in without
